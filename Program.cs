...
namespace OLShopApp
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("\n!Welcome to RotoCube!");
            Console.WriteLine("------------------");
            Console.WriteLine("Welcome to our Online Store! Thank you for visiting and hope you find the right Mice that you are looking for. For questions or concerns, just send us a message and we'll get back to you as soon as we're available. Offensive or harsh messages WILL NOT BE TOLERATED therefore will not get a reply from us.);
            Console.WriteLine("------------------");
